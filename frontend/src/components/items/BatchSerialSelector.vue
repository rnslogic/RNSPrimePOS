				...
				<div v-if="hasSerialNo && (!hasBatchNo || selectedBatch) && !loading">
					...
					<div class="flex gap-2 mb-2">
						<input
							...
							class="flex-1 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-3 py-1.5 text-sm focus:outline-none placeholder-gray-400 dark:placeholder-gray-500"
