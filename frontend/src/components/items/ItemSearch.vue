...
<template>
	...
	>
		...
		<input
			...
			class="flex-1 bg-transparent pl-2 pr-2 py-2 text-sm text-gray-900 dark:text-gray-100 border-none focus:outline-none focus:border-transparent placeholder-gray-400 dark:placeholder-gray-500"
		/>
