...
<template>
	...
	>
		<div class="text-center">
			<!-- Animated checkmark -->
			<div
				class="kiosk-check-ring mx-auto mb-8 flex h-32 w-32 items-center justify-center rounded-full"
				style="
			...
			>
				<svg
					class="kiosk-check-icon h-16 w-16"
					style="color: #4ade80"
					fill="none"
					viewBox="0 0 24 24"
					stroke="currentColor"
			...
			<!-- Thank you -->
			<h1 class="mb-3 text-5xl font-bold text-white" style="letter-spacing: -0.03em">
				Thank You!
			</h1>
			<p class="mb-2 text-lg" style="color: rgba(255, 255, 255, 0.4)">
				Your payment was successful
			</p>
			<!-- Amount paid -->
			<p
				v-if="paymentStore.lastInvoice"
				class="mb-1 text-sm"
			...
			<div class="mb-8 flex items-center justify-center gap-3">
				<div
					class="h-1.5 w-32 overflow-hidden rounded-full"
