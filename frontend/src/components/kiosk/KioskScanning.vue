...
<template>
	<div class="flex h-full flex-col select-none" style="background: #0f172a">
		...
		<div class="flex flex-1 flex-col overflow-hidden">
			...
			>
				<div
					class="kiosk-scan-pulse mx-auto mb-8 flex h-36 w-36 items-center justify-center rounded-3xl"
					style="
			...
			<div v-else class="flex flex-1 flex-col overflow-hidden">
				...
				>
					...
					<p class="text-sm font-medium" style="color: #4ade80">
						Continue scanning or type item code below
					</p>
				</div>
					...
					<div class="space-y-3">
						...
						>
							...
							<div v-if="!item.is_free_item" class="flex items-center gap-2">
								...
								<span class="w-8 text-center text-lg font-bold text-white">{{
									item.qty
								}}</span>
								<button
									class="flex h-11 w-11 items-center justify-center rounded-full text-lg font-bold text-white active:scale-90"
							...
							<!-- Line total -->
							<p
								class="w-24 text-right text-lg font-bold"
		...
		<div class="px-5">
			<Transition name="scan-toast">
				...
				>
					...
					<p class="text-sm font-medium truncate" style="color: #4ade80">
						Added: {{ lastScanned }}
					</p>
				</div>
			</Transition>
