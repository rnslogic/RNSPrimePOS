...
<template>
	...
	>
		<div class="text-center">
			...
			<div
				class="kiosk-card-tap mx-auto mb-10 flex h-32 w-32 items-center justify-center rounded-3xl"
				style="
			...
			<div class="mb-10 flex items-center justify-center gap-2">
				<div
					class="kiosk-dot h-3 w-3 rounded-full"
					style="background: #60a5fa; animation-delay: 0s"
				/>
				<div
					class="kiosk-dot h-3 w-3 rounded-full"
					style="background: #60a5fa; animation-delay: 0.2s"
				/>
				<div
					class="kiosk-dot h-3 w-3 rounded-full"
					style="background: #60a5fa; animation-delay: 0.4s"
				/>
			</div>
			<!-- Cancel -->
			<button
