...
<template>
	<div
		v-if="settingsStore.allowDiscountChange"
		...
		>
			...
			<div class="flex items-center gap-1.5">
				<span
					...
					class="px-1.5 py-0.5 bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 rounded text-[10px] font-bold"
				>
		...
		<Transition name="expand">
			<div v-if="expanded" class="px-3 pb-3 space-y-2">
				...
				<input
					...
					class="w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 focus:bg-white dark:focus:bg-gray-700 text-gray-900 dark:text-gray-100 px-3 py-2 text-sm font-semibold focus:outline-none focus:border-orange-400 transition-all duration-200"
				/>
			</div>
		</Transition>
	</div>
